        ...
        public override string GetInfoString(HttpRequestBase request, string message = null)
        {
            ...
            if (version != null && version.Major != 0)
            {
                ...
                That's a very recent version of the .NET Framework, but you can upgrade fairly easily to the 3.5 version by downloading the 2.8 meg installer for {0}. {1}";
                            ...
                            message += string.Format(formatOfNetInfoString, Constants.htmlLinkToDotNet35Download, explain, this.Is40BetaInstalled(request) ? "also" : "");
                        }
                        break;
                    case 5:
