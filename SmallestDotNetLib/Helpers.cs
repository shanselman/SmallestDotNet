...
public class Helpers
{
    public static string GetUpdateInformation(string UserAgent, Version version)
    {
                        ...
                        case 1:
                            {
                                ...
                                netInfoString += String.Format("Looks like you've {3} got a <strong>pretty old version of .NET</strong>. You should make sure your computer is up to date by visiting {0} then downloading the {1} from Microsoft. {2}", Constants.htmlLinkToWindowsUpdate, Constants.htmlLinkToDotNet35Download, explain, net4 ? "also" : "");
                            }
                            break;
                    }
                    break;
                case 2:
                    {
                     ...
                     That's a fairly recent version of the .NET Framework, but you can upgrade fairly easily to the newest version by downloading the 2.8 meg ""bootstrapper"" for {0}. {1}", Constants.htmlLinkToDotNet35Download, explain, net4 ? "also" : "");
                    }
                    break;
                case 3:
                    switch (version.Minor)
                    {
                     ...
                     That's a very recent version of the .NET Framework, but you can upgrade fairly easily to the 3.5 version by downloading the 2.8 meg installer for {0}. {1}", Constants.htmlLinkToDotNet35Download, explain, net4 ? "also" : "");
                            }
                            break;
                        case 5:
        ...
        else
        {
            ...
            {
                string explain = String.Format(Constants.whyItIsSmallMessage, 60);
                netInfoString += String.Format(@"I can't tell if you've got .NET installed. Perhaps you don't have .NET installed or perhaps 
                  ...
                  This will make sure your system is up to date with the lastest stuff, including the latest .NET Framework.", Constants.htmlLinkToDotNet35Download, explain, Constants.htmlLinkToWindowsUpdate);
            }
        }
