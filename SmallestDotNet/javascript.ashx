...
public class SmallestDotNet : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        WriteToResponse(Helpers.GetUpdateInformation(context.Request.UserAgent, context.Request.Browser.ClrVersion.ToString()).Text.Replace("'", @"\'").Replace(Environment.NewLine, "<br />"));
