...
--%>													
	...
	<img src="images/headerphoto.jpg" width="820" height="120" alt="headerphoto" class="no-border" />
		...
		<div id="main">	
			...
			<p><asp:Literal runat="server" Visible="true" id="userResult" /></p>
            </div>
			...
			<p>If you look for .NET Downloads on Microsoft's site, it might look like the .NET Framework is 200+ megs. <strong>It's not</strong>. Those big downloads are the Complete Offline Versions of every version of the .NET 
			Framework for every kind of machine possible. The big .NET download includes x86, x64, and ia64. It includes .NET 2.0, 3.0, and 3.5 code for all systems all in one super-archive.</p>
			...
			<p>For technical or debugging purposes, this is exactly what your browser said about itself:<br /><asp:Literal runat="server" id="userAgent" /></p>
...
--%>							
		...
		<div id="rightbar">
			...
			<p><strong>SmallestDotNet.com</strong> is a single page site that does one thing. It tells you the smallest, easiest download you'd need to get the .NET Framework on your system. <strong><span id="smaller">The size of the .NET download is usually WAY smaller than you think it'll be.</span></strong>
			There's no database, no cookies, and nothing about your computer has been stored or kept. We just look at the information your browser already reports about your computer and make a suggestion as to the best .NET Framework download for you.</p>  
...
<div id="footer">
	...
	<div class="footer-left">
		<p class="align-left">			
		&copy; 2008 <strong><a href="http://www.hanselman.com/">Scott Hanselman</a></strong> |
